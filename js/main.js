...
(function () {
  ...
  var HERO_CANDIDATES = (
    ...
    'assets/images/hero/hero.webp,assets/images/hero/hero.jpg,assets/images/hero/hero.avif'
  ).split(',').map(function (s) { return s.trim(); }).filter(Boolean);
  ...
  function ensureHeroReady() {
    ...
    heroReadyPromise = firstAvailable(HERO_CANDIDATES)
      ...
      .catch(function () {
        /* Absolute fallback — paint the JPEG rather than stall forever */
        if (heroImg) heroImg.src = 'assets/images/hero/hero.jpg';
        heroIsReady = true;
        return false;
      });
  ...
  /* ---------------------------------------------------------
     8 · Countdown  ·  Grand Reception · 15 Dec 2026, 18:00 IST
     --------------------------------------------------------- */
  (function countdown() {
    var target = new Date('2026-12-15T18:00:00+05:30').getTime();
